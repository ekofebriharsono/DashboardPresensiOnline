                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-header">Form Pendaftaran</div>
                                                        <div class="card-body card-block">
                                                            <form action="proses_php/proses_input_karyawan.php" method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="checkbox" id="acp" name="acp" placeholder="Nama" value="Dapat Login di Admin Website">
                                                                        <label for="">Dapat Login di Admin Website</label>
